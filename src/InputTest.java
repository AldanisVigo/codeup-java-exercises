...
public class InputTest {
    public static void main(String[] args){
        ...
        System.out.printf("> You got it! %d is in the range!",input.getInt(20,40,null));
        ...
        System.out.printf("> You got it! %.5f is in the range!",input.getDouble(20.0,40.0,"Testing optional prompt before parsing double\n".describeConstable()));

        //Let the user know we want an integer again
        System.out.print("I'm thinking of an integer in a range, what is it? : ");

        //Call getInt() without parameters
        System.out.printf(" > You got it! %d is in the range",input.getInt("Testing the optional prompt\n".describeConstable()));

        //Let the user know we want a decimal again
        System.out.print("I'm thinking of a decimal in a range, what is it? : ");

        //Call getDouble() without parameters
        System.out.printf(" > You got it %.5f is in the range", input.getDouble(null));
